  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-6 py-20 relative overflow-hidden">
      ...
      <div className="max-w-4xl w-full text-center space-y-12 animate-fade-in relative z-10">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[hsl(var(--primary)/0.1)] border border-[hsl(var(--primary)/0.2)] text-[hsl(var(--primary))] text-sm font-medium mb-4 no-print">
          <Sparkles size={14} />
          <span>The Ultimate Print Experience</span>
        </div>

        <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-tight text-[hsl(var(--foreground))]">
        ...
        <p className="text-xl md:text-2xl text-[hsl(var(--muted-foreground))] max-w-2xl mx-auto leading-relaxed">
          The most elegant way to print the most famous words in computing history.
          Ready to make your mark on paper?
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 no-print">
          <button
            onClick={handlePrint}
            className="group px-8 py-4 rounded-xl gradient-primary text-white font-bold text-lg shadow-glow hover:shadow-xl transition-all hover:-translate-y-1 flex items-center gap-2"
          >
            <Printer size={20} className="group-hover:rotate-12 transition-transform" />
            Print Now
          </button>
          
          <div className="flex items-center gap-2 text-sm text-[hsl(var(--muted-foreground))] px-6 py-4 rounded-xl border border-[hsl(var(--border))] glass">
            <Terminal size={16} />
        ...
        <div className="mt-20 print:mt-10 mx-auto max-w-2xl">
          <div className="aspect-[1/1.41] bg-white rounded-lg shadow-elegant border border-[hsl(var(--border))] p-12 text-left relative overflow-hidden group">
            {/* Top Bar for UI feel */}
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <h2 className="text-4xl font-serif text-black leading-tight italic">
                  Hello World
                </h2>
              ...
              <div className="pt-20 space-y-4 no-print">
            ...
            {/* Print-only content replacement or addition */}
            <div className="hidden print:block absolute inset-0 p-20 flex items-center justify-center text-center">
               <h1 className="text-7xl font-serif font-bold italic rotate-[-5deg]">Hello World</h1>
            </div>
          </div>
          <p className="mt-4 text-sm text-[hsl(var(--muted-foreground))] no-print">
